...
<html lang="en">
    ...
    <body>
        <?php $url= "http://".$_SERVER['HTTP_HOST']."/PHP-1"?>
        ...
        <nav class="navbar navbar-expand-lg navbar-light opacity-75"  style="background-color: #0d6efd;">
            <ul class="nav navbar-nav  fs-4">
                ...
                <li class="nav-item">
                    <a class="nav-link text-light" href="Mantenedor.php"> Mantenedor</a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link text-light" href="Consultar_Pagos.php"> Gastos comunes</a>
                </li>
                <li class="nav-item">
