        ...
        <nav class="navbar navbar-expand-lg navbar-light opacity-75"  style="background-color: #0d6efd;">
            <ul class="nav navbar-nav  fs-4">
                <li class="nav-item fs-6 nav-link disabled user-select-none ">
                    <a class="nav-link text-light" href="index2_0.php">
                ...
                <li class="nav-item ">
                    <a class="nav-link text-light" href="inicio.php">
                        
                        Inicio
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-light" href="Ingresar_gastos.php"> Ingresar gastos</a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link text-light" href="Consultar_Pagos.php"> Consultar pagos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-light" href="Generar_Informe.php"> Generar informes</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-light" href="Galeria_Imagenes.php">Galeria</a>
                </li>
            </ul>
        </nav>
    </body>
